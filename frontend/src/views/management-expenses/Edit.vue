    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
            <b-row>
                <b-col md="10">
                    <strong>Modulo de Egreso Gerencial | Editar</strong>
                </b-col>
                <b-col md="2">
...
function ViewExpense() {
    ...
    let url = this.url_base + "management-expenses/view/"+id_expense;
    axios({
        method: "GET",
        url: url,
        headers: {token:this.muser.api_token, module:this.module, role:this.role},
...
function EditManagementExpense() {

    let me = this;
    let url = this.url_base + "management-expenses/edit";
