<template>
      ...
      <CCol :xs="12">
        <CCard class="mb-4">
          <CCardHeader>
              <b-row>
                  <b-col md="10">
                      <strong>Modulo Liquidación Diaria Ingresos | Ver</strong>
                  </b-col>
                  <b-col md="2">
                  ...
                  <b-row class="justify-content-center">
                      ...
                      <b-col md="2">
                          <b-form-group label="Código" :description="errors.code">
                              <b-form-input disabled class="text-center" size="sm" v-model="income.code"></b-form-input>
                          </b-form-group> 
                      </b-col>
                      ...
                      <b-col md="2">
                          <b-form-group label="Año" :description="errors.year">
                              <b-form-select disabled size="sm" v-model="income.year" :options="year"></b-form-select>
                          </b-form-group> 
                      </b-col>
  
                      <b-col md="2">
                          <b-form-group label="Mes" :description="errors.month">
                              <b-form-select disabled size="sm" v-model="income.month" :options="month"></b-form-select>
                          </b-form-group> 
                      </b-col>
  
                      <b-col md="2">
                          <b-form-group label="Estado">
                              <b-form-select disabled size="sm" v-model="income.state" :options="state"></b-form-select>
                          </b-form-group> 
                      </b-col>
  
                       <b-col md="2">
                          <b-form-group label="Contado - Total PEN" :description="errors.counted_total_pen">
                              <input  disabled type="number" class="text-end form-control form-control-sm" step="any" v-model="income.counted_total_pen">
                          </b-form-group> 
                      </b-col>
             
                      <b-col md="2">
                          <b-form-group label="Contado - Total USD" :description="errors.counted_total_usd">
                              <input disabled type="number" class="text-end form-control form-control-sm" step="any" v-model.lazy="income.counted_total_usd">
                          </b-form-group> 
                      </b-col>
  
                      <b-col md="2">
                          <b-form-group label="Tarjeta - Total PEN" :description="errors.credit_total_pen">
                              <input disabled type="number" class="text-end form-control form-control-sm" step="any" v-model.lazy="income.credit_total_pen">
                          </b-form-group> 
                      </b-col>
             
                      <b-col md="2">
                          <b-form-group label="Tarjeta - Total USD" :description="errors.credit_total_usd">
                              <input disabled type="number" class="text-end form-control form-control-sm" step="any" v-model.lazy="income.credit_total_usd">
                          </b-form-group> 
                      </b-col>
                      ...
                      <b-col md="12">
                          <b-form-group label="Observación">
                              <b-form-input disabled size="sm"  v-model="income.observation"></b-form-input>
                          </b-form-group> 
                      </b-col>
                  </b-row>
  ...
  function ViewIncome() {
      ...
      let url = this.url_base + "daily-settlement-incomes/view/"+id_income;
      axios({
          method: "GET",
          url: url,
          headers: {token:this.muser.api_token, module:this.module, role:this.role},
  ...
  function EditSettelementIncome() {
  
      let me = this;
      let url = this.url_base + "daily-settlement-incomes/edit";
