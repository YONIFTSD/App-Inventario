    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
            <b-row>
                <b-col md="10">
                    <strong>Modulo de Ingreso Gerencial | Editar</strong>
                </b-col>
                <b-col md="2">
...
function EditManagementIncome() {

    let me = this;
    let url = this.url_base + "management-incomes/edit";
...
function Validate() {
    ...
    if (this.validate) {
     ...
     Swal.fire({
      title: "Esta seguro de modificar el ingreso gerencial?",
      text: "",
      icon: "warning",
