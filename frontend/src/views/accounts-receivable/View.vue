                ...
                <b-row class="justify-content-center">
                    ...
                    <b-col md="6">
                        <b-form-group :description="errors.id_client">
                            <label class="form-label bv-no-focus-ring col-form-label pt-0" for="id_client">Cliente:</label>
                            <Select2 disabled v-model="account_receivable.id_client" placeholder="Seleccione un cliente"  :options="clients" :settings="settings" />
                        </b-form-group> 
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Doc. Referencia">
                            <b-form-input disabled size="sm" v-model="account_receivable.reference"></b-form-input>
                        </b-form-group> 
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Fecha Emisión" :description="errors.broadcast_date">
                            <b-form-input disabled type="date" size="sm" v-model="account_receivable.broadcast_date"></b-form-input>
                        </b-form-group> 
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Fecha Vencimiento" :description="errors.expirate_date">
                            <b-form-input disabled type="date" size="sm" v-model="account_receivable.expirate_date"></b-form-input>
                        </b-form-group> 
                    </b-col>

                    <b-col md="6">
                        <b-form-group label="Observación">
                            <b-form-input disabled size="sm" v-model="account_receivable.observation"></b-form-input>
                        </b-form-group> 
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Moneda" :description="errors.coin">
                            <b-form-select disabled size="sm" :options="coin" v-model="account_receivable.coin"></b-form-select>
                        </b-form-group> 
                    </b-col>
           
                    <b-col md="2">
                        <b-form-group label="Tipo de Cambio" :description="errors.exchange_rate">
                            <b-form-input disabled class="text-end" size="sm" v-model="account_receivable.exchange_rate"></b-form-input>
                        </b-form-group> 
                    </b-col>

                    <b-col md="2">
                        <b-form-group label="Total" :description="errors.total">
                            <b-form-input disabled type="number" step="any" class="text-end" size="sm" v-model="account_receivable.total"></b-form-input>
                        </b-form-group> 
                    </b-col>
