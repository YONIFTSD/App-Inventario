    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
            <b-row>
                <b-col md="10">
                    <strong>Modulo Egreso de Cobros | Editar</strong>
                </b-col>
                <b-col md="2">
...
function ViewExpense() {
    ...
    let url = this.url_base + "accounts-receivable-expenses/view/"+ id_expense;
    me.isLoading = true;
    axios({
        method: "GET",
        url: url,
...
function EditExpense() {
    let me = this;
    let url = this.url_base + "accounts-receivable-expenses/edit";
