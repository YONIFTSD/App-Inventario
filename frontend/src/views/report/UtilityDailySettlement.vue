    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
            <b-row>
                <b-col md="12">
                    <strong>Reporte Utilidad de Liquidación Diaria</strong>
                </b-col>
            </b-row>
        </CCardHeader>
        <CCardBody>
            <b-form @submit="Validate">
                ...
                <b-row class="justify-content-center">
                    ...
                    <b-col md="1">
                        <b-form-group label=".">
                            <b-button @click="ExportExcel" class="form-control" size="sm" variant="success" type="button"><font-awesome-icon icon="fa-solid fa-file-excel" /></b-button>
                        </b-form-group> 
                    </b-col>
...
export default {
    ...
    data() {
      return {
        isLoading:false,
        module:'ReportUtilityDailySettlement',
        role:'List',
        report:{
...
function ExportExcel(){
    let me = this;
    let url = me.url_base + "excel-report-utility-daily-settlement/"+me.report.from+"/"+me.report.to+"/"+me.report.coin;
...
function Report() {
    ...
    let me = this;
    let url = this.url_base + "report/utility-daily-settlement";
