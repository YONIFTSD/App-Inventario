    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
            <b-row>
                <b-col md="12">
                    <strong>Reporte de Gastos USD - Mensual</strong>
                </b-col>
            </b-row>
        </CCardHeader>
        <CCardBody>
...
export default {
    ...
    data() {
      return {
        isLoading:false,
        module:'ReportUtilityAccountReceivableMonth',
        role:'List',
        report:{
...
function ExportExcel(){
    let me = this;
    let url = me.url_base + "excel-report-month-utility-account-receivable/"+me.report.month;
...
function Report() {
    ...
    let me = this;
    let url = this.url_base + "report/month-utility-account-receivable";
