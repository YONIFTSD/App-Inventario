    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
            <b-row>
                <b-col md="12">
                    <strong>Reporte de Gastos - Liquidación Diaria</strong>
                </b-col>
            </b-row>
        </CCardHeader>
        <CCardBody>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-end">{{total.income_counted_usd}}</td>
                                    <td class="text-end">{{total.income_counted_pen}}</td>
...
export default {
    ...
    data() {
      return {
        isLoading:false,
        module:'ReportUtilityDailySettlementMonth',
        role:'List',
        report:{
        ...
        total:{
            income_pen:'0.00',
            income_usd:'0.00',
            income_counted_pen:'0.00',
            income_counted_usd:'0.00',
            expense_pen:'0.00',
            expense_usd:'0.00',
            balance_pen:'0.00',
            balance_usd:'0.00',
...
function ExportExcel(){
    let me = this;
    let url = me.url_base + "excel-report-month-utility-daily-settlement/"+me.report.month;
...
function Report() {
    ...
    let me = this;
    let url = this.url_base + "report/month-utility-daily-settlement";
