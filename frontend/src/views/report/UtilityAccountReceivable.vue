    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
            <b-row>
                <b-col md="12">
                    <strong>Reporte Acumulado USD</strong>
                </b-col>
            </b-row>
        </CCardHeader>
        <CCardBody>
...
export default {
    ...
    data() {
      return {
        isLoading:false,
        module:'ReportUtilityAccountReceivable',
        role:'List',
        report:{
...
function ExportExcel(){
    let me = this;
    let url = me.url_base + "excel-report-utility-account-receivable/"+me.report.from+"/"+me.report.to+"/"+me.report.coin;
...
function Report() {
    ...
    let me = this;
    let url = this.url_base + "report/utility-account-receivable";
