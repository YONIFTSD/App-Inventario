    ...
    <CCol :xs="12">
      <CCard class="mb-4">
        <CCardHeader>
            <b-row>
                <b-col md="12">
                    <strong>Reporte Utilidad - Mensual</strong>
                </b-col>
            </b-row>
        </CCardHeader>
        <CCardBody>
...
function ExportExcel(){
    let me = this;
    let url = me.url_base + "excel-report-month-utility/"+me.report.month;
...
function Report() {
    ...
    let me = this;
    let url = this.url_base + "report/month-utility";
