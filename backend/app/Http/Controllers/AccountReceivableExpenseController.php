...
use App\Models\AccountReceivableExpense; 
use Illuminate\Http\Request;


class AccountReceivableExpenseController extends Controller
{
    /**
    ...
    public function ListAll($from,$to,$search){
        try{
            $result = AccountReceivableExpense::ListAll($from,$to,$search);
    ...
    public function View($id_expense){
        try{
            $obj = AccountReceivableExpense::GetById($id_expense);
    ...
    public function Store(Request $request){
        try{
            ...
            $correlative = Correlative::GetByModule('AccountReceivableExpense');

            $obj = new AccountReceivableExpense();
    ...
    public function Update(Request $request){
        try{
            ...
            $obj = AccountReceivableExpense::find($request->id_expense);
            $obj->description = $request->description;
            $obj->id_user = $request->id_user;
    ...
    public function Delete($id_expense){
        try{
            ...
            $obj = AccountReceivableExpense::find($id_expense);
            $obj->state = 9;
            $obj->update();
