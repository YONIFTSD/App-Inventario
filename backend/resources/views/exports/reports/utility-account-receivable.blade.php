...
<head>
    ...
    <title>R. Util. Registro de Cobros</title>
</head>
<body>
    <table>
        <thead>
            ...
            <tr>
                <th style="background-color: #007bff; color: #ffffff; text-align: center;" colspan="{{count($title)+1}}">REPORTE DE UTILIDAD DE GESTION DE COBROS</th>
            </tr>
