...
<body>
    <table>
        <thead>
            ...
            <tr>
                <th style="background-color: #007bff; color: #ffffff; text-align: center;" colspan="{{count($title)+1}}">REPORTE DE UTILIDAD DE LIQUIDACIÓN DIARIA</th>
            </tr>
