...
<head>
    ...
    <title>R. Utililidad Mensual</title>
</head>
<body>
    <table>
        <thead>
            ...
            <tr>
                <th style="background-color: #007bff; color: #ffffff; text-align: center;" colspan="5">R. DE UTIL MENSUAL - {{ $month}}</th>
            </tr>
            ...
            <tr>
                <th colspan="2"></th>
                <th style="background-color: #007bff; color: #ffffff; text-align: right;">Utilidad USD</th>
                <th>{{$total['balance_usd']}}</th>
            </tr>
            <tr>
                <th colspan="2"></th>
                <th style="background-color: #007bff; color: #ffffff; text-align: right;">Utilidad PEN</th>
