...
<body>
    <table>
        <thead>
            ...
            <tr>
                <th style="background-color: #007bff; color: #ffffff; text-align: center;" colspan="5">R. DE UTIL MENSUAL DE LIQUIDACIÓN DIARIA - {{ $month}}</th>
            </tr>
            ...
            <tr>
                <th colspan="5" style="background-color: #007bff; color: #ffffff; text-align: center;">DIFERENCIA EFECTIVO MENSUAL</th>
            </tr>
            <tr>
                <th colspan="3" style="background-color: #007bff; color: #ffffff; text-align: center;">Descripción</th>
                <th style="background-color: #007bff; color: #ffffff; text-align: center;">T. USD</th>
                <th style="background-color: #007bff; color: #ffffff; text-align: center;">T. PEN</th>
            </tr>
            ...
            <tr>
                <th style="text-align: center;" colspan="3">INGRESO EFECTIVO</th>
                <th>{{$total['income_counted_usd']}}</th>
                <th>{{$total['income_counted_pen']}}</th>
            </tr>
       
            <tr>
                <th style="text-align: center;" colspan="3">EGRESO EFECTIVO</th>
                <th>{{$total['expense_usd']}}</th>
                <th>{{$total['expense_pen']}}</th>
            </tr>

            <tr>
                <th style="text-align: center;" colspan="3">RESTANTE EFECTIVO</th>
