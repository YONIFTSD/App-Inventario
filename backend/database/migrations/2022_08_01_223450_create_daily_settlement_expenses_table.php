...
class CreateDailySettlementExpensesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('daily_settlement_expenses', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->charset = 'utf8';
    ...
    {
        Schema::dropIfExists('daily_settlement_expenses');
    }
}
